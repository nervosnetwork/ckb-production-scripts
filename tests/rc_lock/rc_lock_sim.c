...
UTEST(owner_lock_rc, on_wl_pass) {
  ...
  set_smt_settings(IdentityFlagsOwnerLockRc, &rcrule_slice, &proof_slice,
                   &smt_flags, 1);
...
UTEST(owner_lock_rc, no_rcrule_not_pass) {
  ...
  g_setting.flags = IdentityFlagsOwnerLockRc;
...
UTEST(owner_lock_rc, on_wl_and_not_on_bl_pass) {
  ...
  set_smt_settings(IdentityFlagsOwnerLockRc, rcrules, proofs, smt_flags,
                   countof(smt_flags));
...
UTEST(pubkey_hash_rc, on_wl_pass) {
  ...
  set_smt_settings(IdentityFlagsPubkeyHashRc, &rcrule_slice, &proof_slice,
                   &smt_flags, 1);
...
UTEST(pubkey_hash_rc, no_rcrule_not_pass) {
  ...
  g_setting.flags = IdentityFlagsPubkeyHashRc;
