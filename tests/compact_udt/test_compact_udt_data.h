...
GenerateTransaction::AddCellArgs args_00 = {
    10000, users_00, proof_00, true, true, input_type_id_00, input_type_id_00};
...
GenerateTransaction::AddCellArgs args_01 = {
    ...
    false, input_type_id_01, input_type_id_01};
...
GenerateTransaction::AddCellArgs args_02 = {
    ...
    false, input_type_id_02, input_type_id_02};
...
GenerateTransaction::AddCellArgs args_03 = {
    ...
    false, input_type_id_03, input_type_id_03};
}  // namespace TestData
...
inline void gen_test_data_single(GenerateTransaction* tx) {
  int cell_00 = tx->add_cell(TestData::args_00);
  tx->add_transfer(cell_00, TestData::pubkey_00, cell_00, TestData::pubkey_02,
                   5, 1);
  tx->add_transfer(cell_00, TestData::pubkey_01, cell_00, TestData::pubkey_03,
                   10, 1);
}
